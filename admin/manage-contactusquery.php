...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_REQUEST['eid'])) {
		...
		$msg = "Testimonial successfully unarchive";
	}
	...
	<head>
		...
		<title>Hasta Car Pro |Admin Manage Queries </title>
												...
												foreach ($results as $result) { ?>
													<tr>
														...
														<?php } else { ?>
															...
															<td><a href="manage-contactusquery.php?eid=<?php echo htmlentities($result->id); ?>"
