...
function checkDateAvailability($date)
{
    ...
    try {
        $sql = "SELECT COUNT(*) as count FROM tblbooking WHERE FromDate = :date";
        $query = $dbh->prepare($sql);
        $query->bindParam(':date', $date, PDO::PARAM_STR);
        $query->execute();
        $result = $query->fetch(PDO::FETCH_ASSOC);

        // If count is 0, the date is available
...
if (isset($_POST['submit'])) {
    ...
    if (checkDateAvailability($fromdate)) {
        ...
        echo "<script>alert('The selected date is not available. Please choose another date.');</script>";
    }
          ...
          <div class="sidebar_widget">
            ...
            <form method="post">
              <div class="form-group">
                <input type="date" class="form-control datepicker" name="fromdate" placeholder="From Date(dd/mm/yyyy)"
                  required>
              </div>
              <div class="form-group">
                <input type="date" class="form-control datepicker" name="todate" placeholder="To Date(dd/mm/yyyy)"
                  required>
              </div>
              <div class="form-group">
    ...
    $(function () {
      $(".datepicker").datepicker({
        ...
        beforeShowDay: function (date) {
          ...
          // Allow only Mondays (1) and Wednesdays (3)
          var isSelectable = day === 1 || day === 3;
